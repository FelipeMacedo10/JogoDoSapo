...
function setDifficulty() {
    ...
    if (difficulty === 'easy') {
        carTypes[0].speed = 1.6; // truckImage
        carTypes[1].speed = 4;   // fastCarImage
        carTypes[2].speed = 2.4;   // carImage
        carTypes[3].speed = 0.8; // bulldozerImage
    } else if (difficulty === 'medium') {
        carTypes.forEach(type => type.speed = type.speed);
    } else if (difficulty === 'hard') {
        carTypes[0].speed = 3;   // truckImage
        carTypes[1].speed = 7.5;   // fastCarImage
        carTypes[2].speed = 4.5;   // carImage
        carTypes[3].speed = 1.5; // bulldozerImage
    }
}
